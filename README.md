...
| `/sp3cmar-context` | Phase-0 briefing for a topic (3ngram + GitHub + codebase) |
| `/sp3cmar-acceptance` | Verify a GH issue has acceptance criteria + linkage before starting |
