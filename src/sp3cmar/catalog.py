...
CORE_SKILL_SPECS: tuple[SkillSpec, ...] = (
    ...
    SkillSpec(
        ...
        command="/sp3cmar-review-codebase",
        description="Run codebase architecture review",
        category="Spec & Review",
        providers=("claude", "codex"),
        triggers=("architecture review", "codebase review"),
        tags=("review", "architecture"),
    ),
    SkillSpec(
        slug="review-kill",
        command="/sp3cmar-review-kill",
        description="Run adversarial kill report",
        category="Spec & Review",
        providers=("claude", "codex"),
        triggers=("kill report", "adversarial review"),
        tags=("review", "risk"),
    ),
    SkillSpec(
        slug="review-pr",
        command="/sp3cmar-review-pr",
        description="Review PR for correctness, risks, and doc impact",
        category="Spec & Review",
        providers=("claude", "codex"),
        triggers=("PR review", "review this change"),
        tags=("review", "pr"),
    ),
    SkillSpec(
        slug="docs",
    ...
    SkillSpec(
        ...
        command="/sp3cmar-review-contract",
        description="Validate frontend-backend API contract alignment",
        category="Plan & Build",
        providers=("claude", "codex"),
        triggers=("contract review", "API contract"),
        tags=("review", "api"),
    ),
    SkillSpec(
        slug="review-test",
        command="/sp3cmar-review-test",
        description="Audit test quality, coverage gaps, and test smells",
        category="Review",
        providers=("claude", "codex"),
        triggers=("test review", "coverage gaps"),
        tags=("review", "tests"),
    ),
    SkillSpec(
        slug="release-notes",
...
AGENT_SPECS: tuple[AgentSpec, ...] = (
    ...
    AgentSpec("review-codebase", "Review Codebase", "Run codebase architecture review"),
    AgentSpec("review-kill", "Review Kill", "Run adversarial kill report"),
    AgentSpec("review-pr", "Review PR", "Review PR for correctness, risks, and doc impact"),
